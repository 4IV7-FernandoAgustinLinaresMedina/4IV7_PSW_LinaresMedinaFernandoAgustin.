...
public class ModificarAlumno extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                //vamos a modificar en la bd (insert)
                int bol;
                String n, appate, apmate, t;
                
                //es obtener los parametros
                n = request.getParameter("nom");
                appate = request.getParameter("appate");
                apmate = request.getParameter("apmate");
                t = request.getParameter("t");
                bol= Integer.parseInt(request.getParameter("buscarboleta"));

                
                //querry
                String q = "UPDATE alumnobatiz SET nombre='"+n+"',appat='"+appate+"',apmat='"+apmate+"',telefono='"+t+"' WHERE boleta='"+bol+"' ";
                //se ejecuta la sentencia
                set.executeUpdate(q);
                out.println("<h1>Se Modifico al alumno</h1>");
                ...
                System.out.println("Error al Modificar en la tabla");
